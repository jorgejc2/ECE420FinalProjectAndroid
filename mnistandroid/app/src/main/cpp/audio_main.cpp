...
JNIEXPORT void JNICALL
        Java_mariannelinhares_mnistandroid_MainActivity_createSLEngine(JNIEnv *env, jclass, jint, jint);
JNIEXPORT void JNICALL
        Java_mariannelinhares_mnistandroid_MainActivity_deleteSLEngine(JNIEnv *env, jclass type);
JNIEXPORT jboolean JNICALL
        Java_mariannelinhares_mnistandroid_MainActivity_createSLBufferQueueAudioPlayer(JNIEnv *env, jclass);
JNIEXPORT void JNICALL
        Java_mariannelinhares_mnistandroid_MainActivity_deleteSLBufferQueueAudioPlayer(JNIEnv *env, jclass type);

JNIEXPORT jboolean JNICALL
        Java_mariannelinhares_mnistandroid_MainActivity_createAudioRecorder(JNIEnv *env, jclass type);
JNIEXPORT void JNICALL
        Java_mariannelinhares_mnistandroid_MainActivity_deleteAudioRecorder(JNIEnv *env, jclass type);
JNIEXPORT void JNICALL
        Java_mariannelinhares_mnistandroid_MainActivity_startPlay(JNIEnv *env, jclass type);
JNIEXPORT void JNICALL
        Java_mariannelinhares_mnistandroid_MainActivity_stopPlay(JNIEnv *env, jclass type);
}

JNIEXPORT void JNICALL
Java_mariannelinhares_mnistandroid_MainActivity_createSLEngine(
...
JNIEXPORT jboolean JNICALL
Java_mariannelinhares_mnistandroid_MainActivity_createSLBufferQueueAudioPlayer(JNIEnv *env, jclass type) {
